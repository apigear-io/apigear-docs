...
## What is API Monitoring?[​](#what-is-api-monitoring "Direct link to What is API Monitoring?")
...
## How to setup the monitoring server?[​](#how-to-setup-the-monitoring-server "Direct link to How to setup the monitoring server?")
...
If your template supports tracing, please consult the individual template documentation.
