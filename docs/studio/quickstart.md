...
## Welcome Screen[​](#welcome-screen "Direct link to Welcome Screen")
...
## Project Workspace[​](#project-workspace "Direct link to Project Workspace")
...
## Working with Modules[​](#working-with-modules "Direct link to Working with Modules")
...
### Running Generation[​](#running-generation "Direct link to Running Generation")
...
### Auto-Run Mode[​](#auto-run-mode "Direct link to Auto-Run Mode")
...
### Installed Tab[​](#installed-tab "Direct link to Installed Tab")
...
### Available Tab[​](#available-tab "Direct link to Available Tab")
...
### Simulation Events[​](#simulation-events "Direct link to Simulation Events")
...
## Application Logs[​](#application-logs "Direct link to Application Logs")
...
### Connection Tab[​](#connection-tab "Direct link to Connection Tab")
