...
## Template Filters[​](#template-filters "Direct link to Template Filters")
...
## String Filter[​](#string-filter "Direct link to String Filter")

The list of the common string filters are listed here

### **snake**, **Snake**, **SNAKE**[​](#snake-snake-snake "Direct link to snake-snake-snake")
...
### **camel**, **Camel**, **CAMEL**[​](#camel-camel-camel "Direct link to camel-camel-camel")
...
### **dot**, **Dot**, **DOT**[​](#dot-dot-dot "Direct link to dot-dot-dot")
...
### **kebap**, **Kebap**, **KEBAP**[​](#kebap-kebap-kebap "Direct link to kebap-kebap-kebap")
...
### **path**, **Path**, **PATH**[​](#path-path-path "Direct link to path-path-path")
...
### **upperFirst**[​](#upperfirst "Direct link to upperfirst")
...
### **lowerFirst**[​](#lowerfirst "Direct link to lowerfirst")
...
### **first**, **First**, **FIRST**[​](#first-first-first "Direct link to first-first-first")
...
### **trimPrefix**[​](#trimprefix "Direct link to trimprefix")
...
### **trimSuffix**[​](#trimsuffix "Direct link to trimsuffix")
...
### **int2word**, **Int2Word**, **INT2WORD**[​](#int2word-int2word-int2word "Direct link to int2word-int2word-int2word")
...
## Language Filters[​](#language-filters "Direct link to Language Filters")
...
### **{lang}Return**[​](#langreturn "Direct link to langreturn")
...
### **{lang}Param**[​](#langparam "Direct link to langparam")
...
### **{lang}Params**[​](#langparams "Direct link to langparams")
...
### **{lang}Default**[​](#langdefault "Direct link to langdefault")
...
### **{lang}Vars**[​](#langvars "Direct link to langvars")
...
### **{lang}Var**[​](#langvar "Direct link to langvar")
...
### **{lang}Type**[​](#langtype "Direct link to langtype")
...
## C++14 Filters[​](#c14-filters "Direct link to C++14 Filters")
...
## Go Filters[​](#go-filters "Direct link to Go Filters")
...
## TypeScript Filters[​](#typescript-filters "Direct link to TypeScript Filters")
...
## QtC++ Filters[​](#qtc-filters "Direct link to QtC++ Filters")
...
## Python Filters[​](#python-filters "Direct link to Python Filters")
...
## Unreal Engine Filters[​](#unreal-engine-filters "Direct link to Unreal Engine Filters")
