...
## ObjectLink Protocol for Simulation[​](#objectlink-protocol-for-simulation "Direct link to ObjectLink Protocol for Simulation")

The simulation server can be called using the ObjectLink protocol over WebSockets. The protocol is described in the [ObjectLink specification](/docs/protocols/objectlink/intro.md).
...
## Feeding the Simulation Server[​](#feeding-the-simulation-server "Direct link to Feeding the Simulation Server")
