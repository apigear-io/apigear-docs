---
title: Help & Support
description: Get help with ApiGear - report bugs, request features, and join the community
---
...
2. **Try the latest version** — The issue might be fixed in a newer release
3. **Gather information** — The more details you provide, the faster we can help
...
[Report a Bug →](https://github.com/apigear-io/cli/issues/new)
...
[Request a Feature →](https://github.com/apigear-io/cli/issues/new)
...
- **[CLI Repository](https://github.com/apigear-io/cli)** — The command-line tool written in Go
- **[Studio Repository](https://github.com/apigear-io/studio)** — The desktop application
- **[Template Repositories](https://github.com/apigear-io)** — Language-specific code generators

### Documentation

Help improve the docs you're reading right now:

- **[Documentation Repository](https://github.com/apigear-io/apigear-docs)** — Fix typos, clarify explanations, add examples
