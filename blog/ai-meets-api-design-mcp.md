...
## MCP in 30 Seconds[​](#mcp-in-30-seconds "Direct link to MCP in 30 Seconds")
...
## From Plain English to a Working SDK[​](#from-plain-english-to-a-working-sdk "Direct link to From Plain English to a Working SDK")
...
## Set It Up in One Minute[​](#set-it-up-in-one-minute "Direct link to Set It Up in One Minute")
...
That's it. Your AI assistant now has access to ApiGear's full generation pipeline — spec validation, template browsing, and SDK generation — all through natural conversation. See the [MCP Server documentation](/docs/cli/mcp.md) for the full list of available tools and setup options for other clients.

## Try It Yourself[​](#try-it-yourself "Direct link to Try It Yourself")

1. [Install ApiGear](/docs/cli/intro.md#installation)
2. [Register the MCP server](/docs/cli/mcp.md#setup) with your AI assistant
...
* [mcp](/blog/tags/mcp.md)
* [ai](/blog/tags/ai.md)
* [sdk](/blog/tags/sdk.md)
* [code-generation](/blog/tags/code-generation.md)
